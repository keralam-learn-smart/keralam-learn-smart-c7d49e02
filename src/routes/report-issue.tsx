...
export const Route = createFileRoute("/report-issue")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Report bugs, incorrect answers or security issues on Traffic Tips.",
      },
    ],
    ...
    <SiteLayout>
      <article className={`mx-auto max-w-2xl px-4 py-8 ${ml}`}>
        <h1 className="text-3xl font-bold">
          {t("Report an Issue", "പ്രശ്നം റിപ്പോർട്ട് ചെയ്യുക")}
        </h1>
        <p className="mt-2 text-muted-foreground">
          {t(
            "Spotted something wrong? Wrong answer, broken page, incorrect translation, or a security concern — let us know and we'll fix it.",
        ...
        <div className="mt-6 space-y-3">
          ...
          <FeedbackDialog kind="suggestion">
            <Button variant="outline" className="w-full">
              {t("Suggest an Improvement", "നിർദ്ദേശം നൽകുക")}
            </Button>
          </FeedbackDialog>
        </div>
      </article>
