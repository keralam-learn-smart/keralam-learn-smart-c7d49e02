  ...
  head: () => ({
    meta: [
      { title: "Driving Learning Guide — Traffic Tips" },
      {
        name: "description",
        content:
          "A complete driving learning guide covering driver training, vehicle laws, traffic rules, penalties and road safety — expandable, bilingual and completely free.",
      },
